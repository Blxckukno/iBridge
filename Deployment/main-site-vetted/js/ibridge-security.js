...
class iBridgeSecurity {
    ...
    setupHTTPSRedirect() {
        // Only force HTTPS on public production hosts
        const isProduction = !this.isLocalOrPrivateHost(window.location.hostname);
    ...
    addConnectionIndicator() {
        ...
        const isLocalhost = this.isLocalOrPrivateHost(window.location.hostname);
