...
function initializeForms() {
    ...
    forms.forEach(form => {
        form.addEventListener('submit', async function (e) {
            ...
            if (errors.length > 0) {
                showFormErrorNotification(errors.join('<br>'));
            ...
            try {
                ...
                showFormErrorNotification('An error occurred. Please try again later.');
            } finally {
                submitBtn.innerHTML = originalBtnText;
                submitBtn.disabled = false;
            }
...
// Professional form error notification system
function showFormErrorNotification(message) {
    // Remove any existing notification
    const existingNotification = document.querySelector('.form-error-notification');
    ...
    notification.innerHTML = `
        <div style="display: flex; align-items: flex-start; gap: 12px;">
            <i class="fas fa-exclamation-triangle" style="color: #fff; margin-top: 2px;"></i>
            <div>
                <div style="font-weight: 600; margin-bottom: 8px;">Form Validation Error</div>
                <div style="font-size: 0.9rem; line-height: 1.4; opacity: 0.95;">${message}</div>
            </div>
        </div>
    `;
