...
Write-Host "Success Rate: $SuccessRate percent" -ForegroundColor $(if ($SuccessRate -ge 80) {"Green"} elseif ($SuccessRate -ge 60) {"Yellow"} else {"Red"})
...
Valid Scripts: $($Results.Valid.Count) ($SuccessRate percent)
